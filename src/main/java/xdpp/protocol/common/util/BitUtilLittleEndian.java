package xdpp.protocol.common.util;
 ...
 **/
public class BitUtilLittleEndian {
     ...
     * @return
     */
    public static int bytesDecodeInt(byte[] data, int startOffset,  int lengthIn) {
    ...
    public static long getBinaryNumber(byte[] data, int startOffset, int lengthIn){
         ...
         * 开始的字节数组下标
         */
        int startByte = data.length - 1 - (startOffset / 8);
        /***
         * 开始的 bit 位置
         */
